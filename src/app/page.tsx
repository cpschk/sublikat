  ...
  return (
    <main className="bg-white text-black font-sans space-y-8 p-6">
      ...
      >
        ...
        <p className="mb-6">[Descripción del concepto de AR y personalización]</p>
      ...
      >
        <h2 className="text-xl font-semibold mb-4">[Historia: Quiénes Somos]</h2>
      ...
      >
        <h2 className="text-xl font-semibold mb-6 text-center">[Productos Personalizados]</h2>
      ...
      >
        <h2 className="text-xl font-semibold mb-6 text-center">[Testimonios de Clientes]</h2>
      ...
      >
        ...
        <div className="border border-black p-4 bg-white">
          <p>[Placeholder para campos del formulario (nombre, email, mensaje)]</p>
        </div>
