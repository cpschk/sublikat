  ...
  return (
    <>
      ...
      <ScrollStack stackPosition={stackPosition} itemStackDistance={0} itemDistance={400}>
        ...
        <ScrollStackItem>
          <section
            className="relative flex flex-col justify-center items-center p-6 md:p-8"
        ...
        <ScrollStackItem>
          <section
            className="border border-black p-6 md:p-8 bg-gray-100 flex flex-col justify-center items-center h-[90vh]"
